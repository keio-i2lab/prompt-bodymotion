clear;clc;
for num_class = [2.1, 2.01, 2.5, 2.9, 2.001, 2]
    for str_postfix2 = ["free talk","rating","both"]
        for str_postfix1 = ["all","noB","noH9-Y2","noB-H9-Y2"]
            ...
            str_method = "SVM";
            numstd = 1.96; %95 percent = 1.96 std
...
%     end
    ...
    best_mdl = fitcsvm( train_pred, train_label ...
                ,'KernelFunction','RBF','Standardize',true ...
                ,'OptimizeHyperparameters','all' ...
                ,'HyperparameterOptimizationOptions',struct('UseParallel',true,'Optimizer','gridsearch','Verbose',0,'ShowPlots',false) ...
                );
            
	test_result = best_mdl.predict(test_pred);
    best_struct_acc  = compute_accuracy_metrics(test_result, test_label);
