...
%         disp(str_curfile);
    ...
    mat_score = D_score;
    save( strcat("181222_D_",str_curversion),"mat_score","cell_namelist","mat_ALL_ANGLE_feats","mat_ALL_feats","mat_ALL_ADD_feats","mat_feats_explanation");
    mat_ALL_feats = H;
    mat_ALL_ANGLE_feats = H_angle;
    mat_ALL_ADD_feats = H_additional;
    cell_namelist = H_namelist;
    mat_score = H_score;
    save( strcat("181222_H_",str_curversion),"mat_score","cell_namelist","mat_ALL_ANGLE_feats","mat_ALL_feats","mat_ALL_ADD_feats","mat_feats_explanation");
end
fclose(file_log);
